/*
  ...
  - Added the required column `place` to the `Gottesdienst` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Gottesdienst" ("assignees", "book", "comments", "createdAt", "date", "entries", "id", "kirchgemeindeId", "liked", "likes", "music", "running", "special", "time", "title", "type", "updatedAt", "userId") SELECT "assignees", "book", "comments", "createdAt", "date", "entries", "id", "kirchgemeindeId", "liked", "likes", "music", "running", "special", "time", "title", "type", "updatedAt", "userId" FROM "Gottesdienst";
